...
public class CaptchaController {
    ...
    public boolean verify(@Parameter(name = "scenario", description = "业务场景", required = true) @RequestParam BusinessScenario scenario,
                          @Parameter(name = "captchaId", description = "场景 id", required = true) @NotBlank(message = "验证码 ID 不能为空") String captchaId,
                          @Parameter(name = "inputCode", description = "验证码", required = true) @NotBlank(message = "验证码不能为空") String inputCode) {
